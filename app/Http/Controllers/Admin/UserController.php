...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user->syncRoles($request->role);
        $user->save();    
        return redirect()->route('admin.user.index')->with('success', 'Account update successful');
    }
    public function delete(Request $request)
    {
        ...
        if(!$flag) return redirect()->back()->with('error', "Unable to delete logged in user account");
    ...
    public function postResetPassword(Request $request,$id)
    {
        ...
        $customName =[
            'password' => 'Password',
            'confirm_password' => 'Enter the password'
        ];
        $validator = Validator::make($request->all(),$rule,$messages,$customName);
        if($validator->fails())
        {
        ...
        $user->save();
        return redirect()->route('admin.user.index')->with('success', 'Change password successfully');
    }
    ...
    public function searchUserDiscount(Request $request)
    {
        ...
        return response()->json([
            'error' =>false,
            'data'=> $list_user,
            'message' => 'Find a successful account',
        ]);
    }
}
