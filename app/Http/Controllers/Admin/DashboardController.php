...
{
    // sản phẩm dưới 11 là báo sắp hết
    ...
    public function orderMonth(Request $request)
    {
        ...
        $data = [
            ...
            'isDashboard' => true,
            'title_page' => 'Monthly Invoice '.$month.'/'.$year,
            'title_delete' =>'Delete invoice',
    ...
    public function newOrder(Request $request)
    {
        ...
        $data = [
            ...
            'isDashboard' => true,
            'title_page' =>'New orders',
            'title_delete' =>'Delete new order',
