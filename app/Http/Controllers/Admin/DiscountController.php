...
class DiscountController extends Controller
{
    ...
    public function edit(Request $request,$id)
    {
        if(empty($id))
        {
            return redrect()->route('admin.discount.index')->with('error','Discount not found');
        }
        ...
        if(empty($discount))
        {
            return redirect()->route('admin.discount.index')->with('error','Discount not found');
        }
    ...
    public function store(Request $request)
    {
        ...
        {
            return redirect()->back()->with('error','Need to choose a discounted account');
        }
        ...
        if(empty($request->id))
        {
            ...
            if($request->type_discount == "product")
            {
                ...
                {
                    return redirect()->back()->with('error','Need to select a category or product to be discounted');
                }
            ...
            return redirect()->route('admin.discount.index')->with('success','Create discount successful');
        }
    }
    public function delete(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Delete discount successfully');
    }
}
