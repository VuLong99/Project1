...
class ProductController extends Controller
{
    ...
    public function edit(Request $request,$id)
    {
        ...
        if(empty($product))
        {
            return redirect()->route('admin.product.index')->with('error', 'sản phẩm không tìm thấy');
        }
    ...
    public function store(Request $request)
    {
        ...
        if(empty($request->id))
        {
            ...
            return redirect()->route('admin.product.index')->with('success', 'Create products successful');
        }
    ...
    public function addTag($id = '',Request $request)
    {
        ...
        return response()->json([
            'error'=>false,
            'message'=>'Create keywords successful',
            'data'=>$data,
        ]);
    }
    ...
    public function removeTag($id = '',Request $request)
    {
        ...
        if(empty($id_tag))
        {
            return response()->json([
                'error'=>true,
                'message'=>'Product keywords could not be found',
                'data' => null,
            ]);
        }
