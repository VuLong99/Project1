...
class TagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(empty($request->id_tag))
        {
            ...
            if(!empty($tag))
            {
                return redirect()->back()->with('error', 'Keyword already exists');
            }
            $tag = new tag();
        ...
        $tag->slug = Str::slug($request->name_tag,'-');
        $tag->save();
        return redirect()->back()->with('success', 'Keyword update successful');
    }
    ...
    public function delete(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Delete keyword successfully');
    }
}