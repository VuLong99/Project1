...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(empty($category))
        {
            return redirect()->route('admin.category.index')->with('error', 'No category found');
        }
    ...
    public function delete(Request $request)
    {
        ...
        foreach($list_id as $id)
        {
            ...
            {   
                ...
                {
                    return redirect()->back()->with('error', 'Category '.$category->name.' product is available');
                }
            }
        }
        ...
        return redirect()->back()->with('success', 'Remove category successfully');
    }
}
