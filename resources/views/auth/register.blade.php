				...
				<div class="form-inner" style="width:100%">
				  <form method="post" action="{{route('register.post')}}" id="form-register" class="text-left">
					...
					<div class="form-group-material">
						...
						<label for="register-confirm_password" class="label-material">Enter the password</label>
					...
					<div class="form-group text-center">
						<span style="background-color:#FE980F;border-color:#FE980F" id="register" class="btn btn-custom btn-primary">Register</span>
					  <!-- This should be submit button but I replaced it with <a> for demo purposes-->
					</div>
				  </form>
				  {{-- <a href="#" class="forgot-pass">Forgot Password?</a> --}}
				  <small>Are you have account? </small><a href="{{route('login')}}" class="signup">Login</a>
				</div>
