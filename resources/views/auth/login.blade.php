				...
				<div class="form-inner" style="width:100%">
				  <form method="post" id="form-login" class="text-left" action="{{route('login')}}">
					...
					<div class="form-group text-center">
						  <button style="submit" style="background-color:#FE980F;border-color:#FE980F" id="login" type="submit" class="btn btn-primary btn-custom">Login</button>
					<!-- This should be submit button but I replaced it with <a> for demo purposes-->
					</div>
				  </form>
				  <a href="{{route('password.update')}}" class="forgot-pass">Forgot Password?</a>
				  <small>Are you have account? </small><a href="{{route('register.get')}}" class="signup ">Register</a>
				</div>
