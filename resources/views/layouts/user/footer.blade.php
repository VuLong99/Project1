<footer id="footer"><!--Footer-->
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked" style="flex-direction: column-reverse;">
								<li><a href="{{ url('/about') }}">Introduce</a></li>
								<li><a href="{{ url('/exchange') }}">Return Policy</a></li>
					...
					<div class="col-sm-3 col-sm-offset-1">
						<div class="single-widget">
							...
							@csrf
								<input name="contact_name" id="contact-name"  type="text" placeholder="Name"/>
								...
								<input name="contact_email" id="contact-email"  type="text" placeholder=" Email"/>
								...
								<textarea  name="content" id="contact-content"  rows="5" placeholder="Content"></textarea>
								<div class="error error-content" @if(isset($errors) && $errors->has('content')) style="display:block" @endif>{{$errors->first('content')}}</div>
								<br>
								<button type="submit" class="btn btn-default btn-send btn-custom">Submit</button>
							</form>
						</div>
					</div>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2021 FLASH-CART</p>
				</div>
			</div>
		</div>
