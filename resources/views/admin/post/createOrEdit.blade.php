...
@section('content')
  <section class="charts">
        ...
        <div class="container-fluid">
          <header> 
            <h1 class="h3 display">{{($flag = !empty($rows) && $rows->id) ? 'Update post' : 'Create post'}}</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <form id="form-post" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('admin.post.store')}}">
                            ...
                            <div class="form-group row">
                              <div class="col-sm-3">
                                ...
                                <input id="name" type="text"  @if($flag) value="{{$rows->name}}" @endif name="name" placeholder="Name" class="form-control" onkeyup="ChangeToSlug();">
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="custom-file">
                                    <input id="path" type="text" name="path" @if($flag) value="{{$rows->path}}" @endif placeholder="Path" class="form-control" readonly onkeyup="ChangeToSlug();">
                              ...
                              <div class="col-sm-3">
                                ...
                                <div class="custom-file">
                                    <input id="author" type="text" name="author" @if($flag) value="{{$rows->author}}" @endif placeholder="Author" class="form-control">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                  ...
                                  <textarea id="description" rows="5" name="description" placeholder="Enter a description" class="form-control">@if($flag) {{$rows->description}} @endif</textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                  ...
                                  <textarea id="content" rows="5" name="content" placeholder="Content" class="form-control">@if($flag) {{$rows->post_content}} @endif</textarea>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-4">
                                  <label class="label-check label">Image</label>
                                  <div class="custom-file">
                                      <input type="file" name="image" @if($flag) value="{{$primary}}" @endif accept=".jpg, .jpeg, .png" class="custom-file-input img-pro" id="file" data-toggle="tooltip" title="{{!empty($primary->name) ? $primary->name : 'Choose'}} " data-placement="bottom">
                            ...
                            <div class="form-group row">       
                              <div class="col-sm-12">
                                <button id="create" type="submit" data-edit="{{isset($rows->id) ? $rows->id : -1}}" class="btn btn-disabled btn-primary">Save</button>
                              </div>
                            </div>
                        </form>
                    </div>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group row">
                  <div class="col-sm-12">
                    <input id="input-tag" type="text" name="input-tag" placeholder="Add keywords" class="form-control">
...
@section('script')
  ...
  <script>
    ...
    $('#form-post').submit(function(e){
        ...
        if(name == '') {
          $('.error-name').html('Enter post title');
          $('.error-name').css('display','block');

          $('.error-path').html('Enter the article name to get the link');
        ...
        if(author == '') {
          $('.error-author').html('Enter the author name');
        ...
        if(description == '') {
          $('.error-description').html('Enter a description');
        ...
        if(content == '') {
          $('.error-content').html('Enter a content');
