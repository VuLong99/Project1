...
<section class="charts">
    <div class="container-fluid">
        <!-- Page Header-->
        <header> 
            <h1 class="h3 display">{{ (isset($row->id) && $row->id) ? 'Discount details' : 'Create a discount'}}</h1>
        </header>
        <div class="row">
            <div class="col-lg-12">
                <form id="form-discount" method="POST" action="{{route('admin.discount.store')}}">
                  @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">     
                          <label class="label">{{ (isset($row->id) && $row->id) ? 'Products or categories are discounted' : 'Select a discounted product or category'}}</label>
                        </div>
                        <div class="col-sm-12">                           
                            <div class="i-checks">
                             ...
                             <div class="form-group product row mt-3 form-check">
                                <div class="col-sm-12">
                                    ...
                                    @if(!$flag)<span data-target="#modal-product"  data-toggle="modal" class="btn btn-primary">{{ $flag ? 'Update discount products' : 'Create discount products'}}</span>@endif
                                  <div class="error error-product">Select the product to be discounted</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="i-checks">
                             ...
                             <div class="form-group category row mt-3 form-check">
                                <div class="col-sm-12">
                                  ...
                                  <div class="error error-category">Select the category you want to discount</div>
                                </div>
                            </div>
                        </div>
                    </div>
                   <div class="form-group row">
                        <div class="col-sm-6">
                          ...
                          <input id="sale_price" @if($flag) disabled @endif  @if($flag) value="{{$row->sale_percent}}" @endif type="text" name="sale_price" placeholder="Discount" class="form-control ">
                        ...
                        <div class="col-sm-6">
                          ...
                          <input id="discount_code" disabled type="text" value="{{$row->discount_code}}" name="discount_code" placeholder="Discount code" class="form-control ">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12">
                        ...
                        @if(!$flag)<button style="margin-top:5px;" type="button" data-target="#modal-email"  data-toggle="modal" class="btn btn-primary">{{ $flag ? 'Update account list' : 'Add account list'}}</button>@endif
                        <div class="show-user">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">{{ $flag ? 'Update discount products' : 'Add discount products'}}</h4>
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-sm-12 button-save">
                <center><span id="save-product" class="btn btn-primary">Save</span></center>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="modal-category">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">{{ $flag ? 'Update discount category' : 'Add discount category'}}</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      ...
      <div class="modal-body">
        <div class="form-group row">
          <div class="col-sm-12">
              <input id="search-category" type="text" placeholder="Search category" class="form-control">
          </div>
          ...
          <div class="col-sm-12 button-save">
              <center><span id="save-category" class="btn btn-primary">Save</span></center>
          </div>
        </div>
      </div>
...
<div class="modal fade" id="modal-email">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">{{ $flag ? 'Update account discount' : 'Add discount account'}}</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      ...
      <div class="modal-footer">
         <div class="row">
           <div class="col-sm-12">
            <center><button id="save-user" class="btn btn-primary">Save</button></center>
           </div>
         </div>
      </div>
