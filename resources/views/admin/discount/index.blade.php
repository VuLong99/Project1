...
<section class="charts">
  <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Discount</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex">
                  ...
                  <form id="delete-discount" action="{{ route('admin.discount.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Remove discount</button>
                  </form>
                  {{-- Form search desktop --}}
                  <button class="btn btn-primary btn-create">Add discount</button>
                </div>

                <div class="card-header card-header-form" >
                  <form class="form-inline" style="float: right;" method="GET" action="{{route('admin.discount.index')}}">
                    <div class="form-group">
                      <label for="start_date_search" class="label">Start date:</label>
                      <input id="start_date_search" value="{{Request::get('start_date_search')}}" name="start_date_search" type="date" class="mr-3 form-control">
                    </div>

                    <div class="form-group">
                      <label for="end_date_search" class="label">Enad date:</label>
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="t-center">{{ ($row->type == "product") ? "Product" : "Category"}}</td>
