              ...
              <div class="card">
                <div class="card-header" style="display:flex;">
                  ...
                  <form id="delete-role" action="{{ route('admin.role.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Remove role</button>
                  </form>
                 ...
                 {{-- Form search desktop --}}
                  <button class="btn btn-primary btn-create">Create role</button>
                </div>
          ...
          <div class="modal-body">
            <form id="form-role" action="{{route('admin.role.store')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text"  value="{{Request::get('search')}}"is placeholder="Name" name="name_role" id="name_role" class="form-control">
                <div class="error error-role">Enter role</div>
              </div>
            </form>
          </div>
