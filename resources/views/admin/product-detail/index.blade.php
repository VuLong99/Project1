...
<section class="charts">
  <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Product details</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header" style="display:flex;">
                  <form id="delete-product-detail" action="{{ route('admin.product_detail.delete',['id'=>$product->id]) }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Delete details</button>
                  </form>
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <div class="error error-quantity">Enter QuantityQuantity</div>
                      </div>
                    </div>
                  </div>
  ...
  <script >
    ...
    $('#confirm').click(function(){
      ...
      $('.btn-create').click(function(){
        ...
        $('.modal-title').html('Create details');
        $('#modal-product-detail').modal('show');
      });
