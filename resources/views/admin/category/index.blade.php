...
<section class="charts">
  <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Category</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div  class="card-header" style="display:flex;">
                  ...
                  <form id="delete-category" action="{{ route('admin.category.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Remove category</button>
                  </form>
          ...
          <div class="modal-body">
            <form id="form-category" action="{{route('admin.category.store')}}" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" placeholder="Category name" name="name_category" id="name_category" class="form-control">
                <div class="error error-category">Enter the category name</div>
              </div>
            </form>
          </div>
