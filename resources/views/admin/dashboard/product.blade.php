...
<section class="charts">
  <section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header> 
            <h1 class="h3 display">Item is running out</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header" style="display:flex;">
                  <form id="delete-product-detail" action="{{ route('admin.product_detail.delete') }}" method="POST" style=" display: inline;">
                    @csrf
                    @method('DELETE')
                    <input type="hidden" name="list_id" id="list_id" value="">
                    <button disabled type="submit" class="btn btn-danger btn-delete">Remove details</button>
                  </form>
                  ...
                  {{-- <button class="btn btn-primary btn-create">Create details</button> --}}
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><img class="zoom img-product img-thumbnail" src="{{ asset($row->product->getImagePrimary())}}" alt=""></td>
                          <th>{{ $row->name}}</th>
                          <td>{{ $row->size->name }}</td>
          ...
          <div role="document" class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">Create details</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
              </div>
              <div class="modal-body">
                <form id="form-product-detail" action="{{ route('admin.dashboard.product-almost-over-store')}}" method="POST"  enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    ...
                    <div class="col-4">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="quantity" name="quantity" id="quantity" class="form-control">
                        <div class="error error-quantity">Enter quantity</div>
                      </div>
                    </div>
                  </div>
                    ...
                    {{-- <div class="form-group row">
                      <div class="col-sm-6">
                          <label class="label-check">Product image</label>
                          <div class="custom-file">
                              ...
                              <label class="custom-file-label" id="label-file" for="customFile">Choose image</label>
