              ...
              <div class="card">
                <div class="card-header" style="display:flex;">
                  ...
                  <form id="delete-slide" action="{{ route('admin.slide.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Delete slide</button>
                  </form>

                  <button class="btn btn-primary btn-create">Create slide</button>
                </div>
      ...
      <div role="document" class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 id="exampleModalLabel" class="modal-title">Create slide</h5>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <div class="error error-title">Enter title</div>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea type="text" placeholder="content" name="slide_content" id="slide_content" class="form-control"></textarea>
                    <div class="error error-content">Enter content</div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <input id="path" type="text" name="path" class="form-control" placeholder="Path">
                    <div class="error error-path" 	@if($errors->has('path')) style="display:block" @endif>Invalid path</div>
                  </div>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-12">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" id="label-file" for="customFile">Choose</label>
                        <div class="error error-image" 	@if($errors->has('image')) style="display:block" @endif>{{$errors->has('image') ? $errors->first('image') : "Choose"}}</div>
                    </div>                                
                </div>
            </div>
            <div class="form-group">
          ...
          <div class="modal-footer">
            <button type="button" data-dismiss="modal" class="btn btn-slide btn-secondary">Close</button>
            <button type="submit" class="btn btn-slide btn-primary" id="save">Save</button>
          </div>
        </div>
      </div>
    </div>
...
@section('script')
  <script >    
    ...
    $('#save').click(function(e){
      ...
      if($('#path').val() == '')
      {
        $('.error-path').html('Enter the path');
