<form id="form-user" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('admin.user.store')}}">
    ...
    <div class="form-group row">
      <div class="col-sm-6">
        ...
        <input id="username" type="text"  @if($flag) value="{{$rows->username}}" @endif name="username" placeholder="Name" class="form-control">
    ...
    <div class="form-group row">
        <div class="col-sm-4">
          ...
          <input id="phone" type="text" name="phone" @if($flag) value="{{$rows->phone}}" @endif placeholder="Phone number" class="form-control "">
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <label class="label-check label" >Gender</label>
            <div class="i-checks">
                @php 
                    if($flag)
                    {
    ...
    <div class="form-group row">
        <div class="col-sm-6">
            <label class="label-check label" >Avatar</label>
            <div class="custom-file">
                ...
                <label class="custom-file-label" id="label-file" for="customFile">{{!empty($name_file) ? $name_file : 'Choose'}}</label>
