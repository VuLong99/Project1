              ...
              <div class="card">
                <div class="card-header" style="display:flex;">
                  ...
                  <form id="delete-user" action="{{ route('admin.user.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Delete account</button>
                  </form>
                  ...
                  <div class="card-body  card-form" style="padding:0;">
                    <form class="form-inline" style="float: right;" method="GET" action="{{route('admin.user.index')}}">
                      <div class="form-group">
                        <label for="inlineFormInputGroup" class="sr-only">Account</label>
                        <input id="inlineFormInputGroup" value="{{Request::get('search')}}" value="{{Request::get('search')}}" name="search" type="text" placeholder="Account" class="mr-3 form-control form-control">
                      </div>
                      <div class="form-group">
                  ...
                  {{-- Button create --}}
                  <button class="btn btn-primary btn-create" data-url="{{ route('admin.user.create') }}">Create Account</button>
                </div>
                ...
                <div class="card-body  card-form-mob" style="padding:0;">
                    <form class="form-inline" style="float: right;" method="GET" action="{{route('admin.user.index')}}">
                      <div class="form-group">
                        <label for="inlineFormInputGroup" class="sr-only">Account</label>
                        <input id="inlineFormInputGroup" value="{{Request::get('search')}}" name="search" type="text" placeholder="Account" class="mr-3 form-control form-control">
                      </div>
                      <div class="form-group">
                        <input type="submit" value="Search" class="mr-3 btn btn-primary">
                      </div>
                    ...
                    <table class="table table-striped table-hover">
                      ...
                      <tbody>
                        ...
                        <tr> 
                          ...
                          <td>
                            <span class="cursor change-pass" data-id="{{ $row->id }}">Reset Password</span>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
