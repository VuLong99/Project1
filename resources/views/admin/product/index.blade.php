              ...
              <div class="card">
                <div class="card-header" style="display:flex;">
                  ...
                  <form id="delete-product" action="{{ route('admin.product.delete') }}" method="POST" style=" display: inline;">
                    ...
                    <button disabled type="submit" class="btn btn-danger btn-delete">Delete product</button>
                  </form>
                  ...
                  {{-- Form search desktop --}}
                  <button class="btn btn-primary btn-create" data-url="{{ route('admin.product.create') }}">Create products</button>
                </div>
                    ...
                    <table class="table table-striped table-hover" id="myTable2">
                      <thead>
                        <tr>
                          ...
                          <th class="cursor" onclick="sortTable(1)">Category</th>
                          <th class="cursor" onclick="sortTable(2)">Price</th>
