...
<section class="charts">
        ...
        <div class="container-fluid">
          <header> 
            <h1 class="h3 display">{{($flag = !empty($rows) && $rows->id) ? 'Product update' : 'Create products'}}</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <form id="form-product" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('admin.product.store')}}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                  ...
                                  <textarea id="description" rows="5" name="description" placeholder="Description" class="form-control">@if($flag) {{$rows->description}} @endif</textarea>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-12">
                                <label class="label-tag label">Keyword</label>
                                ...
                                <span data-target="#add-tag"  data-toggle="modal" class="btn btn-primary">Add keywords<span>
                              </div>
                          </div>
                          @endif
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group row">
                  <div class="col-sm-12">
                    <input id="input-tag" type="text" name="input-tag" placeholder="Enter keywords" class="form-control">
  ...
  <script>
    ...
    $('#input-tag').keyup(function(e){
      if(e.keyCode == 13)
      {
        ...
        if(value == '')
        {
            $('.error-input-tag').html('Enter keywords');
            return;
        }
