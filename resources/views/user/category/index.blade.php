                        ...
                        <form id="form-sort" action="{{url('category/'.$id)}}">
                            <div class="orderby-wrapper pull-left">
                                ...
                                <select name="sort" id="sort">
                                    ...
                                    <option value="asc" @if(Request::get('sort') == 'asc') selected @endif>Price: Ascending</option>
                                    <option value="desc"@if(Request::get('sort') == 'desc') selected @endif>Price: Decrease</option>
                                    <option value="new" @if(Request::get('sort') == 'new') selected @endif>Latest</option>
                        ...
                        <form class="tree-most" id="form-change-layout" method="get" action="{{url('category/'.$id)}}" method="get">
                            <div class="orderby-wrapper pull-right">
                                ...
                                <select id="display" name="display" class="display">
                                    <option value="grid" @if($display == 'grid') selected @endif>Net</option>
                                    <option value="list"  @if($display == 'list') selected @endif>List</option>
                                </select>
                            </div>
                        </form>
                    </div>
                                            ...
                                            <ul class="nav nav-pills nav-justified ">
                                                <li id="li_{{$pro->id}}" @if(Auth::check() && $pro->checkProductWishList(Auth::id())) class="active-custom" @endif>
                                                    <a class="cursor" onclick="add_wishlist({{$pro->id}})">
                                                        @if(!$pro->checkProductWishList(Auth::id()))<i class="fa fa-plus-square"></i>Add favorites @else Already loved @endif </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a title="Thêm sản phẩm vào giỏ hàng" name="add_to_cart_quick_view" type="button" class="btn btn-primary btn-custom">Buy now</a>
                                                <a type="submit" href="{{URL::to('cart')}}" class="btn btn-primary btn-custom">Go to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
