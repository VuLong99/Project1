        ...
        <div id="discount-box" class="content-order spacing-top-bottom-30px">
            <div class="container">
                <div class="row">
                                ...
                                <table id="customers">
                                    <thead>
                                       <tr >
                                            ...
                                            <th class="t-center">Discount code</th>
                                            <th class="t-center">Type</th>
                                            <th class="t-center">Discount products</th>
                                            <th class="t-center">Reduced price</th>
                                            <th class="t-center">Begin</th>
                    ...
                    @else
                        <div class="col-sm-12">
                            <div><center>No discount</center></div>
                        </div>
                    @endif
                </div>
            </div>
