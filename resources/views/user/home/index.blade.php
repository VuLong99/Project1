            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="features_items">
                    <h2 class="title title-padding text-center">
                        {{ (!empty(Request::get('key_word')) || !empty(Request::get('range_price'))) ? 'Search products' : ((isset($title) && !empty($title)) ? $title : 'Featured products')}}
                    </h2>                                                                           
                                ...
                                <div class="product-image-wrapper item-product">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            {{-- <input type="button" data-toggle="modal" data-target="#xemnhanh" value="View details" class="btn btn-default xemnhanh btn-custom" data-id_product="{{$pro->id}}" name="add-to-cart"> --}}
                                        </div>
                                    </div>
                                    <div class="choose">
                ...
                {{-- @php dd($product_top_wish) @endphp --}}
                    <div class="recommended_items"><!--recommended_items-->
                        <h2 class="title text-center">Favorite product</h2>
