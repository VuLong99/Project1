                        ...
                        <div class="col-sm-4">
                            ...
                            @csrf
                                <select name="sort" id="sort" class="form-control">
                                    ...
                                    <option value="">--Prices go up--</option>
                                    <option value="">--Prices go down--</option>
                                    <option value="">--Names from A to Z--</option>
                                    <option value="">--Names from Z to A--</option>
                                </select>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal fade" id="xemnhanh" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary " data-dismiss="modal" style="margin-bottom: -16px;">Close</button>
                                <button type="button" class="btn btn-primary btn-custom">Go to product</button>
                            </div>
                        </div>
                    </div>
                </div>
