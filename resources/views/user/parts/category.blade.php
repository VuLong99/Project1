<div class="col-sm-3">
    <div class="left-sidebar">
        <h2 class="title-padding">Category of Product</h2>
        ...
        <!-- <div class="price-range">
            ...
            <div class="well text-center">
                <form id="form-filter" method="get" action="{{url('/home')}}">
                    ...
                    <div class="row ">
                        <input type="submit" value="Choose" id="btn-filter" class="btn btn-sm btn-default btn-custom">
                    </div>
                </form>   
            </div>
        </div> -->
        ...
        <div id="container_viewed">
            <h2 class="title-padding">Viewed products</h2>
