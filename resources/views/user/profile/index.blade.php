        ...
        <div class="shopper-informations pb-50">
            <form id="form-user" class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{route('user.profile.store')}}">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <label class="label-check">Sex</label>
                        <div class="i-checks">
                            @php 
                                if($flag)
                                {
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        <label class="label-check">Avatar</label>
                        <div class="custom-file">
                            ...
                            <label style="    border-radius: 5px !important;border: none;background-color: #F0F0E9;" class="custom-file-label" id="label-file" for="customFile">Choose image</label>
                ...
                <div class="form-group row">       
                    <div class="col-sm-12"> 
                        <button type="submit" id="create" class="btn btn-primary btn-custom">Save</button>
                    </div>
                </div>
            </form>
        </div>
